...
# DBTITLE 1,Read bronze delta table, transform to silver, and write silver delta table
df = delta_reader.read(dataSourceObj.bronze_table_name)
df = log_parser.toSilver(df, dataSourceObj)
delta_writer.write(df, dataSourceObj.silver_table_name)
