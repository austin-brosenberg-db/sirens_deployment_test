...
logger.info(f"reading source path from: {config.get('input').get('rawPath')} in {config.get('input').get('streamType')} mode")
...
delta_writer.write(df, dataSourceObj.bronze_table_name)